...
-- This is a modified Lua bundle so
-- Copyright 2014-2015 (c) The Howl Developers - MIT
-- Copyright 2017 (c) rokf - MIT
...
howl.util.lpeg_lexer ->
  ...
  keyword = c 'keyword', word {
     ...
     'then', 'true', 'until', 'while', 'terra', 'quote',
     'struct', 'var', 'union',
  }
  ...
  terra_types = c 'type', any {
    'int', 'int8', 'int16', 'int32', 'int36',
    'uint', 'uint8', 'uint16', 'uint32', 'uint36',
    'bool', 'float', 'double'
  }
